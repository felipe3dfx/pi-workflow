...
The release guard can contain checks that are more specific than normal npm package validation. Those checks are intentional because they protect the harness model, not just the publish pipeline.
