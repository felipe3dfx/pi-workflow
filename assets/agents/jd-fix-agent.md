---
description: Package-owned jd-fix-agent agent
model: openai-codex/gpt-5.6-terra
thinking: medium
capability_profile: code-writer
tools:
  - read
  - grep
  - find
